...
Namespace WebForms
	Public Class BundleConfig
		...
		Public Shared Sub RegisterBundles(bundles As BundleCollection)
			...
			ScriptManager.ScriptResourceMapping.AddDefinition("respond", New ScriptResourceDefinition() With { _
				.Path = "~/Scripts/respond.min.js", _
				.DebugPath = "~/Scripts/respond.js" _
			})
		End Sub
	End Class
End Namespace
